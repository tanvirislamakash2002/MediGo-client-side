...
export function SecuritySection() {
    ...
    const handlePasswordChange = async () => {
        ...
        try {
            const result = await customerProfile.customerChangePassword({
    ...
    const loadSessions = async () => {
        ...
        try {
            const result = await customerProfile.getCustomerActiveSessions();
            if (result.success) {
    ...
    const handleTerminateSession = async (sessionId: string) => {
        const result = await customerProfile.customerTerminateSession(sessionId);
        if (!result.success) {
    ...
    const handleLogoutAll = async () => {
        const result = await customerProfile.customerLogoutOtherSessions();
        if (!result.success) {
